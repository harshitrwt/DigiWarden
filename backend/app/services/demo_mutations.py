...
def generate_demo_variants(root_image_path: str) -> List[DemoVariant]:
    """
    Frontend is not ready yet, so we generate a small set of deterministic
    "derived copies" for demo/testing. This makes the end-to-end API usable
    immediately after uploading any image.
    """
